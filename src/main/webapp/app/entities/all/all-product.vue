    ...
    <div class="m-5">
      <h2 id="page-heading" class="d-flex justify-content-center" data-cy="ProductHeading">
        ...
        <div class="d-flex justify-content-center ">
          ...
          <!--modal for creating-->
          <b-button
            v-on:click="clearDialogProduct()"
            variant="danger"
            class="btn btn-danger mr-2"
            data-cy="entityCreateButton"
            v-b-modal.createEntityProduct>
            + createWithModal
          </b-button>
      ...
      <div class="table-responsive container text-center border border-danger" v-if="products && products.length > 0">
        <table class="table table-striped  p-2 " aria-describedby="products">
          ...
          <tr>
            ...
            <th scope="row" v-on:click="changeOrderProduct('productCategory.id')">
              <span v-text="$t('productCrudApp.product.productCategory')">Product Category</span>
              <jhi-sort-indicator :current-order="propOrderProduct" :reverse="reverseProduct"
                                  :field-name="'productCategory.id'"></jhi-sort-indicator>
            </th>
            <th scope="row"></th>
          </tr>
          </thead>
          ...
          <tr v-for="product in products" :key="product.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                <button
                  v-on:click="prepareEditProduct(product)"
                ...
                <button
                  ...
                  data-cy="editEntityProduct"
                  v-b-modal.editEntityProduct>
      ...
      <!--      Modal for creating-->
      <b-modal ref="createEntityProduct" id="createEntityProduct">
      <span slot="modal-title"
      ><span
      >Create you product</span
      ></span
      >
        <div>
          <div>
        ...
        <div slot="modal-footer">
          ...
          <button
            ...
            v-on:click="save(),handleSyncList()">
            Create
          </button>
        </div>
      ...
      <b-modal ref="editEntityProduct" id="editEntityProduct">
      <span slot="modal-title"
      ><span
      >Edit you product</span
      ></span
      >
        <div>
          <div>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('productCrudApp.product.productName')"
        ...
        <div slot="modal-footer">
          <button type="button" class="btn btn-secondary" v-text="$t('entity.action.cancel')"
                  v-on:click="closeDialogProductUpdate()">Cancel
          </button>
          <button
            type="button"
            class="btn btn-primary"
            id="jhi-confirm-edit-product"
