...
class ProductResourceIT {
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productName(UPDATED_PRODUCT_NAME).productCode(UPDATED_PRODUCT_CODE).productPrice(UPDATED_PRODUCT_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME).productCode(UPDATED_PRODUCT_CODE).productPrice(UPDATED_PRODUCT_PRICE);
